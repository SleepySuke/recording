...
func New(logger *slog.Logger, upload *handler.UploadHandler, query *handler.QueryHandler, retry *handler.RetryHandler, delete *handler.DeleteHandler) *gin.Engine {
	r := gin.New()
	r.Use(
